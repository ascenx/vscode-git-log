...
- Theme-aware current-line blame annotations show the author, relative time, and commit subject. Hovering displays the author email, exact time, commit hash, and full message. Uncommitted edit ages update automatically and are retained in workspace state.
